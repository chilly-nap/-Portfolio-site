    ...
    if (sectionId === 'about') {
        ...
        <div class="projects-container">
            ...
            <div class="project-item" onclick="toggleProjectDetails('project5-details')">
                <img src="project5.jpg" alt="Puzzle Platformer Game" class="project-image">
                <div class="project-description">
                    <h2>Puzzle Platformer Game (Currently working on)</h2>
                    <p>A 2D puzzle-platformer where players control a spirit that can possess objects to solve challenges </p>
                </div>
                <div class="project-details" id="project5-details">
                    ...
                    <div id="project-planned-features">
                        <h3>Planned features:</h3>
                        <ul>
                            <li>Possession mechanic allowing players to inhabit objects like statues, lanterns, and windmills to navigate levels</li>
                            <li>World-shifting ability to reveal hidden pathways and alter level layouts</li>
                            <li>Absorb energy from certain entities to temporarily gain new spectral abilities</li>
                        </ul>
                    </div>
                    <a href="javascript:void(0);" target="_blank">Not on Github as of now</a>
                </div>
